...
tf.app.flags.DEFINE_boolean('single_pass', False,
                            ...
                            'If True, run eval on the full dataset using a '
                            'fixed checkpoint, i.e. take the current checkpoint, '
                            'and use it to produce one summary for each example '
                            'in the dataset, write the summaries to file and then '
                            'get ROUGE scores for the whole dataset. '
                            'If False (default), run concurrent decoding, '
                            'i.e. repeatedly load latest checkpoint, '
                            'use it to produce summaries for randomly-chosen '
                            'examples and log the results to screen, indefinitely.')
...
tf.app.flags.DEFINE_boolean('convert_to_coverage_model', False,
                            ...
                            'Your current training model will be copied to '
                            'a new version (same name with _cov_init appended) '
...
tf.app.flags.DEFINE_boolean('restore_best_model', False,
                            'Restore the best model in the eval/ '
                            'dir and save it in the train/ dir, '
                            'ready to be used for further training.'
                            ' Useful for early stopping, '
                            'or if your training checkpoint has become '
                            'corrupted with e.g. NaN values.')

# Debugging. See https://www.tensorflow.org/programmers_guide/debugger
tf.app.flags.DEFINE_boolean('debug', False, "Run in tensorflow's debug "
                                            "mode (watches for NaN/inf values)")
